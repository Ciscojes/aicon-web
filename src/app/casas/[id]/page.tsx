  ...
  return (
    <div className="public-shell public-inner-shell">
      ...
      <main className="property-detail-page">
        ...
        <section className="property-fact-grid" aria-label="Distribución y medidas">{facts.length > 0 ? facts.map(([value, label]) => <div key={label}><strong>{value}</strong><span>{label}</span></div>) : <div className="fact-pending"><strong>Por confirmar</strong><span>Distribución y medidas</span></div>}</section>
