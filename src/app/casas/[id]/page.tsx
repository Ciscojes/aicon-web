  ...
  return (
    <div className="public-shell public-inner-shell">
      ...
      <main className="property-detail-page">
        ...
        {financialSettings && property.availabilityStatus === "available" ? <FinancingSimulator priceUsd={property.priceUsd} settings={financialSettings} unitId={property.id} /> : null}
      ...
      <PublicSiteFooter appointmentHref={property.availabilityStatus === "available" ? `/agendar-visita?unidad=${property.id}` : undefined} />
    </div>
  );
}
